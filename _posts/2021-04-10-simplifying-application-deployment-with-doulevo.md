...
# Simplifying application deployment with Doulevo

**Removing complex setup and configuration whilst avoiding vendor lock-in**

This paper imagines Doulevo: a command line tool and cloud backend that simplifies building, running, testing and deploying distributed applications and makes development more straightforward for all software developers.
