...
- [Creating the web server](#creatingthewebserver)
- [Creating a proxy REST API](#creatingaproxyrestapi)
- [Plugging the data into the chart](#pluggingthedataintothechart)
- [Computing a simple moving average](#computingasimplemovingaverage)
- [Event handling and chart resize](#eventhandlingandchartresize)
